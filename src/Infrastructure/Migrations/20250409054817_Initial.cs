    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserClientRoles", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_UserClientRoles_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserClientRoles_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSystemRoles_SystemRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "SystemRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSystemRoles_SystemRoles_RoleId1",
                        column: x => x.RoleId1,
                        principalTable: "SystemRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSystemRoles_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserClientRoles_ClientId",
                table: "UserClientRoles",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_UserClientRoles_ClientRoleId",
                table: "UserClientRoles",
                column: "ClientRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserClientRoles_UserId",
                table: "UserClientRoles",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSystemRoles_RoleId1",
                table: "UserSystemRoles",
                column: "RoleId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserSystemRoles_UserId1",
                table: "UserSystemRoles",
                column: "UserId1");
        }
